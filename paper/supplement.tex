...
\textbf{Band-Order Ambiguity in Spectral Mechanism Attribution for PlanetScope Landslide Segmentation}
\end{center}
...
non-overlapping 128-pixel crops, optimisation budget, augmentations, and
...
Supplementary Table~S3 reports the detailed order-specific HR-GLDD operating
